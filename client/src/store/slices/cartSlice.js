...
export const addItemToCart = createAsyncThunk("cart/addItem", async ({ productId, quantity }, thunkAPI) => {
    try {
...
export const removeItemFromCart = createAsyncThunk("cart/removeItem", async (itemId, thunkAPI) => {
    try {
...
export const clearUserCart = createAsyncThunk("cart/clearCart", async (_, thunkAPI) => {
    try {
...
const cartSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(removeItemFromCart.pending, (state) => { state.isLoading = true; })
