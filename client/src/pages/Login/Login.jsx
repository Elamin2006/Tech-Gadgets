    ...
    return (
        <Container fluid className="login-container m-0 p-0 overflow-hidden">
            <Row className="g-0 min-vh-100">
                ...
                <Col lg={6} className="login-brand-side d-none d-lg-flex align-items-center justify-content-center">
                    <div className="tech-grid-overlay"></div>
                    <div className="text-center px-5 z-1" style={{ maxWidth: "500px" }}>
                        <h1 className="login-brand-title login-title" style={{ fontSize: "3.5rem" }}>TECH_ELITE</h1>
                        <p className="mt-3" style={{ color: "var(--color-on-surface-variant)", fontSize: "1.15rem", lineHeight: "1.6" }}>
                            The intersection of performance and precision. Access your elite command center.
                        </p>
                    </div>
                </Col>

                <Col xs={12} lg={6} className="d-flex flex-column align-items-center justify-content-center  p-4 p-md-5 position-relative">
                    ...
                    <div className="login-form-wrapper">
                        <header className="mb-4 text-start">
                            ...
                            <p style={{ color: "var(--color-on-surface-variant)", fontSize: "15px" }}>Enter your credentials to access your professional workspace.</p>
                        </header>

                        {isError && (
                            <Alert variant="danger" className="border-0 text-white d-flex align-items-center rounded-3 mb-4" style={{ backgroundColor: "var(--color-error-container)" }}>
                        ...
                        <Form onSubmit={handleSubmit} noValidate>
                            ...
                            <Form.Group className="mb-4" controlId="formPassword">
                                <div className="d-flex justify-content-between align-items-center mb-2">
                                    <Form.Label className="custom-label text-uppercase m-0">Password</Form.Label>
                                    <Link to="/forgot-password" style={{ color: "var(--color-primary)", fontSize: "12px", fontWeight: "600", textDecoration: "none" }}>Forgot Password?</Link>
                                </div>
