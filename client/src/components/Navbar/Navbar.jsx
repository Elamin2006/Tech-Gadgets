      ...
      <Container className="navbar-container">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className=" flex-grow-1 pe-3 align-items-md-center gap-2">
            ...
            <Nav.Item>
              <Link aria-label="Go to Home Page" className="elite-nav-link" to="/" onClick={() => setExpanded(false)}>
                Home
              </Link>
            </Nav.Item>

            <Nav.Item>
              <Link aria-label="Go to Shop Page" className="elite-nav-link" to="/shop" onClick={() => setExpanded(false)}>
                Shop
              </Link>
            </Nav.Item>
            <Nav.Item>
            ...
            {user ? (
              ...
              <>
                ...
                <Nav.Item>
                  <Button as={Link} to="/register" className="px-3 py-2 rounded-3 btn-signup-elite" onClick={() => setExpanded(false)}>
                    Sign Up
                  </Button>
                </Nav.Item>
              </>
