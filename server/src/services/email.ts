...
export const buildResetMailOptions = (
  ...
  return {
    from: `"Tech Gadgets Support" <${emailUser}>`,
    to: targetEmail,
...
export const buildOrderMailOptions = (
  email: string,
  status: string,
  total: number,
): SendMailOptions => {
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-body">
            ...
            <p>
              We are writing to inform you about the latest update
            ...
            <p>
              <strong>Total Price of Your Order:</strong>
            </p>
